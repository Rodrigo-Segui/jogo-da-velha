public class ComputadorA extends Computador{
	...
	ComputadorA(String nome, String tipo) {
		super(nome,tipo);
	}
	
	/*metodo responsavel pelo algoritmo de escolha de qual quadrante será marcado pela maquinaA*/
	public int numberQuadranteA(Tabuleiro tabuleiro) {
		
		
		/*ComputadorA o quadrante marcado será o primeiro quadrante vazio a partir do inicio do tabuleiro*/
		
				/*Realiza um loop a partir do inicio sobre o tabuleiro até encontrar um quadrante vazio*/
